...
const PacmanEasterEgg: React.FC<Props> = ({
  onPacmanClick,
  darkMode,
  isMobile,
}) => {
  ...
  useEffect(() => {
    ...
    const speed = isMobile ? 300 : 100; // pixels per second
        ...
        (pellet) =>
          !pellet.eaten && (
            <img
              ...
              src={pelletimg}
              alt="Pellet"
              className={classNames("invert-on-dark", styles.pellet)}
              style={{
                width: 12,
                height: 12,
                transform: (() => {
